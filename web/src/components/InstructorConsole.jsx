...
const PromptField = ({ isFull, autoFocus, inputValue, setInputValue, handleSubmit, loading }) => (
    <form onSubmit={handleSubmit} style={{
        ...
        boxShadow: isFull ? '0 10px 40px rgba(0,0,0,0.8), inset 0 2px 4px rgba(255,255,255,0.05)' : 'inset 0 2px 4px rgba(0,0,0,0.5)',
        ...
        <input
            ...
            placeholder={isFull ? "What would you like to build today?" : "Ask Chiron..."}
            style={{
                flex: 1,
        ...
        <button
            ...
            style={{
                ...
                color: isFull ? '#000' : (loading || !inputValue.trim() ? '#333' : '#00ff88'),
                ...
                boxShadow: isFull && !loading && inputValue.trim() ? '0 0 20px rgba(0, 255, 136, 0.4)' : 'none'
            }}
        >
...
const InstructorConsole = () => {
    ...
    return (
        <div style={{
            ...
            <div style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center' }}>
                    <div style={{
                        ...
                        animation: loading ? 'pulse-blue 1.5s infinite ease-in-out' : 'pulse-green 2s infinite ease-in-out'
                    }}></div>
                    <span style={{
                        fontSize: '0.75rem',
                        fontWeight: '800',
                        ...
                        {loading ? 'Consulting Neural Manual...' : 'Chiron Instructor Online'}
                    </span>
                </div>
                {lessonData && (
                    <div style={{ display: 'flex', alignItems: 'center', gap: '15px' }}>
                        <div style={{ fontSize: '0.7rem', color: '#666', fontWeight: 'bold', letterSpacing: '1px' }}>
                        ...
                        <div style={{ display: 'flex', gap: '8px' }}>
                            ...
                            <button
                                ...
                                style={{
                                    ...
                                    borderRadius: '66px',
                                    border: 'none',
                                    backgroundColor: currentStepIndex === lessonData.length - 1 ? '#00ff88' : '#333',
                                    color: currentStepIndex === lessonData.length - 1 ? '#000' : '#fff',
                                    cursor: 'pointer',
                                    fontSize: '10px',
                                    fontWeight: 'bold',
                                    textTransform: 'uppercase',
                                    transition: 'all 0.2s',
                                    boxShadow: currentStepIndex === lessonData.length - 1 ? '0 0 10px rgba(0, 255, 136, 0.4)' : 'none'
                                }}
                            >
            ...
            <div style={{ flex: 1, overflow: 'hidden', marginBottom: currentStep ? '15px' : '0', minHeight: 0, paddingRight: '0', zIndex: 1 }}>
                {loading && (
                    <div style={{
                        height: '100%',
                        display: 'flex',
                ...
                {error && (
                    <div style={{
                        ...
                        <div style={{ fontWeight: 'bold', marginBottom: '5px' }}>Communication Error</div>
                    ...
                    <div className="fade-in">
                        ...
                        <div style={{ display: 'flex', gap: '10px', marginBottom: '25px', flexWrap: 'wrap' }}>
                            <div style={{
                                ...
                                <span style={{ color: '#666', marginRight: '5px' }}>TARGET:</span>
                                <span style={{ color: '#00d4ff', fontWeight: 'bold' }}>{currentStep.ui_target}</span>
                            </div>
                            <div style={{
                                fontSize: '0.7rem',
                                backgroundColor: '#1a1a1a',
                                ...
                                <span style={{ color: '#666', marginRight: '5px' }}>EXECUTE:</span>
